            ...
            <DrawerContent className="bg-white/60 backdrop-blur-md border-none text-text-color overflow-y-scroll">
              <div className="mx-auto w-full max-w-[860px] p-6">
                <DrawerHeader className="px-0">
                  ...
                  <DrawerDescription className="text-subText-color">{item.date}</DrawerDescription>
                </DrawerHeader>
                ...
                <DrawerFooter className="px-0 pt-2 pb-6">
                  ...
                  <DrawerClose asChild>
                    <Button variant="outline" className="w-full border-white/20 cursor-pointer text-text-color hover:bg-white/10">
                      닫기
                    </Button>
                  </DrawerClose>
                </DrawerFooter>
